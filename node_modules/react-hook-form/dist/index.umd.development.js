(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  function useWatch({ control, name, defaultValue, }) {
      ...
      const updateWatchValue = React.useCallback(() => setValue(watchInternal(name, defaultValueRef.current, idRef.current)), [setValue, watchInternal, defaultValueRef, name, idRef]);
      React.useEffect(() => {
